...
function weilerAtherton(polygon1, polygon2) {
  ...
  // Now the main part of the algorithm begins.
      ...
      let it = 0;
      while (start || polygon[0] != polygon[polygon.length-1]&& it < 1000 ) {
          it++;
          start = false;
...
var houseMesh = drawShape(
  rotate([
    ...
    [338.0978 + 1.7 + 0.55965, 158.97892000000002 +0.8 - 64.475122],
...
var p2 = drawShape(
  rotateTangram([
    ...
    [46.958107+.9, 74.249991+0.0],
    [113.79989+0.1, 140.67364+0.2]
  ]),
  "#aa0000"
);
...
var p3 = drawShape(
  rotateTangram([
    [146.53452+0.3, 106.94566+0.4],
    [146.53452+0.5, 106.94566 + 66.88075+0.6],
    [146.53452+0.7 - 33.15276, 106.94566+0.8 + 66.88075 - 33.15277]
  ]),
  "#ff00ff"
);
...
var p4 = drawShape(
  rotateTangram([
    [179.80541+0.9, 73.674771+0.1],
    [179.80541+0.1, 73.674771 + 66.998869+0.2],
    [179.80541 - 33.27089+0.3, 73.674771+0.4 + 66.998869 + 33.15277],
    [179.80541+0.5 - 33.27089, 73.674771+0.6 + 66.998869 + 33.15277 - 66.88075]
  ]),
  "#008080"
);
...
var p5 = drawShape(
  rotateTangram([
    [79.823261+0.7, 173.65692+0.8],
    [79.823261+0.9 + 33.440379, 173.65692+0.4 + 33.440379],
    [79.823261+0.1 + 33.440379 + 33.27088, 173.65692+0.2 + 33.440379 - 33.68902],
    [
      79.823261+0.3 + 33.440379 + 33.27088 - 33.2313,
      173.65692+0.4 + 33.440379 - 33.68902 - 33.23131
    ]
  ]),
  "#ffff00"
);
...
var p6 = drawShape(
  rotateTangram([
    [46.958107+0.5, 206.52207+0.6],
    [46.958107+0.7 + 32.865154, 206.52207+0.8 - 32.86515],
    [46.958107+0.9 + 32.865154 + 33.440369, 206.52207+0 - 32.86515 + 33.44037]
  ]),
  "#800080"
);
...
var p7 = drawShape(
  rotateTangram([
    [113.26364+0.1, 207.09729+0.2],
    [113.26364+0.3 + 66.54177, 207.09729+0.4 - 66.42365],
    [113.26364+0.5 + 66.54177 + 0.41813, 207.09729+0.6 - 66.42365 + 66.42365]
  ]),
  "#808000"
);
...
function onHandleDrop() {
  ...
  if (intersectionArea / (totalArea < 0.1 ? 1000 : totalArea) > 0.97) {
